<?php
	...
	$send_name      = "Forum Ensao Entreprises";		// Replace your name
	$send_title     = "FEE Newsletter";		// Replace email sent title
	$send_address   = "fensaoentreprises@gmail.com";	// Replace your email address
	
	$smtp_address   = "fensaoentreprises@gmail.com";		// Replace your email address
	$smtp_password	= "forum_ensao";				// Replace your email password
