		...
		<div id="gmap_canvas" style="position: relative; overflow: hidden;">
			<div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
				<div class="gm-err-container"><div class="gm-err-content"><div class="gm-err-icon">
					...
					<div class="gm-err-title">Conférenciers</div>En cours ...</div>
					</div></div></div></div>
		<section/>
        <!-- PROGRAM -->
        <section id="program">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="timeline" data-columns>
                            ...
                            <div class="item wrap">
                                ...
                                <div class="overlay"></div>
                                <div class="icon">
                                    <a class="image-popup" href="img/img/gal/Gal (2).jpg" title="<h4>Sed at rutrum felis</h4>Curabitur nec metus tempor, malesuada quam a, laoreet urna."><i class="pe-3x pe-7s-plus"></i></a>
                                </div>
                            </div>
